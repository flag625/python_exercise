...
class TempliteTest(TestCase):
    ...
    def test_reusability(self):
        ...
        templite = Templite("This is {{name|upper}}{{punct}}",globs)
        self.assertEqual(templite.render({'name':'Ned'}),"This is NED!")
        self.assertEqual(templite.render({'name':'Ben'}),"This is BEN!")
    ...
    def test_malformed_for(self):
        ...
        with self.assertSynErr("Don't understand for: '{% for x form y %}'"):
